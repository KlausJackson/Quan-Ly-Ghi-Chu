...
class _TrashPageState extends State<TrashPage> {
  ...
  List<NoteModel> _applyFilterSort(List<NoteModel> source) {
    var list = List<NoteModel>.from(source);
    // filter
            ...
            Column(
              children: [
                ...
                Expanded(
                  child: Builder(
                    builder: (_) {
                      if (provider.status == NoteStatus.loading &&
                        ...
                        return Center(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text('No trashed notes found.'),
                            ],
                          ),
                        );
                      }
                              ...
                              confirmDismiss: (direction) async {
                                if (direction == DismissDirection.startToEnd) {
                                  ...
                                  ShowDialogs.showConfirmationDialog(
                                    ...
                                    onConfirm: () async {
                                      try {
                                        await provider.permanentlyDeleteNote(
                                          note,
                                        );
                                      } catch (e) {
                                        if (mounted) {
